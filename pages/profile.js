                    ...
                    <div className="bg-white p-3 border-t-4 border-indigo-400">
                        <div className="relative image overflow-hidden">
                            <Image
                                ...
                                src="https://i.ibb.co/NtSbRsB/photo-1480429370139-e0132c086e2a-ixlib-rb-1-2.jpg"
                                alt="Profile"
                                width={300}
                                height={300}
                                objectFit="cover"
                            />
                            <span className="top-0 right-0 absolute  w-3.5 h-3.5 bg-indigo-400 border-2 border-white dark:border-gray-800 rounded-full"></span>
                        </div>
                        ...
                        <ul className="bg-gray-100 text-gray-600 hover:text-gray-700 hover:shadow py-2 px-3 mt-3 divide-y rounded shadow-sm">
                            <li className="flex items-center py-3">
                                ...
                                <span className="ml-auto">
                                    <span className="bg-indigo-500 py-1 px-2 rounded text-white text-sm">Active</span>
                                </span>
                            </li>
                            <li className="flex items-center py-3">
